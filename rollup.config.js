...
add_jsy('opaque_web_resp', {category: 'websvr/', all: true})
add_jsy('node_resp', {category: 'websvr/', plat_node: true})
add_jsy('opaque_node_resp', {category: 'websvr/', plat_node: true})
