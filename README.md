...
| ✅ | Browser [IndexedDB API](https://developer.mozilla.org/en-US/docs/Web/API/IndexedDB_API) <br/> `globalThis.indexedDB.open()` | impl: [code/web/web_db.jsy](code/web/web_db.jsy) <br/> test: [test/unittest.web.mjs](test/unittest.web.mjs)
| ✅ | Browser [Fetch API](https://developer.mozilla.org/en-US/docs/Web/API/Fetch_API) <br/> `globalThis.fetch()` | impl: [code/web/web_fetch.jsy](code/web/web_fetch.jsy) <br/> test: [test/unittest.web.mjs](test/unittest.web.mjs)
| ✅ | Browser [Service Worker Cache API](https://developer.mozilla.org/en-US/docs/Web/API/Cache) <br/> `globalThis.caches.open()` | impl: [code/web/web_cache.jsy](code/web/web_cache.jsy) <br/> test: [test/unittest.web.mjs](test/unittest.web.mjs)
...
| ✅ | [CouchDB](http://couchdb.apache.org) <br/> [nano](https://www.npmjs.com/package/nano) | impl: [code/nosql/couchdb.jsy](code/nosql/couchdb.jsy) <br/> test: [test/int--couchdb/integ-test.mjs](test/int--couchdb/integ-test.mjs)
...
| ✅ | [PouchDB](https://pouchdb.com) <br/> [pouchdb](https://www.npmjs.com/package/pouchdb) | impl: [code/nosql/pouchdb.jsy](code/nosql/pouchdb.jsy) <br/> test node: [test/unittest.web.mjs](test/unittest.web.mjs) <br/> test web: [test/unittest.web.mjs](test/unittest.web.mjs) <br/> test with couchdb: [test/int--couchdb/integ-test.mjs](test/int--couchdb/integ-test.mjs)
